...
public interface UserMapper {
    ...
    //会员注册
    Integer register_vip(Gms_Vip gms_vip);

    Gms_Vip finVipById(String id);

    Gms_Vip finVipByPhone(String phone);

    void memberpay(String vip_Phone,String vip_NewAccount);

    String finVipAccountById(String id);

    Gms_Vip finVipByUserid(String id);

    String finVipUseridByPhone(String phone);

    String finVipIdByPhone(String phone);
